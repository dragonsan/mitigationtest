<html>
  <head>
    <meta charset="utf-8"><title>ohaidere.</title>
    <link href='https://fonts.googleapis.com/css?family=Roboto' rel='stylesheet' type='text/css'>
    <style>html,body{font-family:'Roboto',sans-serif;text-align:center}</style>
  </head>
  <body>
    ...
    <small>Unique ID: <?php echo rand(0,9999999); ?></small>
  </body>
</html>
